...
function createGround(scene){
    ...
    BABYLON.SceneLoader.ImportMesh("", "./assets/ground/", "shaat.glb", scene, function (newMeshes) {
        ...
        materialWall.diffuseTexture = new BABYLON.Texture("./assets/ground/whatsapp_image_2023-06-01_at_1.10.28_pm.jpeg", scene);
